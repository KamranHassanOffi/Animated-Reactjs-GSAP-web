        ...
        <div className='flex top-0 fixed justify-between items-start w-full z-4 '>
           ...
           <div onMouseEnter={()=>{
            ...
            onMouseLeave={()=>{
                ...
                Setnavopen(true)
            }} className='lgh:h-13 h-11 lg:w-[16vw] w-40 relative bg-black cursor-pointer'>
                <div ref={navGreenRef} className='bg-[#D3FD50] h-0 w-full top-0 absolute hover:h-full transition-all '></div>
                <div className='relative h-full lg:gap-1 gap-0.5 flex flex-col justify-center items-end lg:px-10 px-8'>
                    <div className='lg:w-18 w-9 h-0.5 bg-white'></div>
