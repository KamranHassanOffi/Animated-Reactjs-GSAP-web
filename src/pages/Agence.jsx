...
const Agence = () => {
  ...
  return (
    ...
    <div>
      <div className='section1'>
        <div ref={imageDivRef} className='overflow-hidden w-[15vw] h-[20vw] rounded-4xl absolute top-96 left-[30vw]'>
          <img ref={imageRef} className='h-full w-full' src="https://k72.ca/images/teamMembers/Carl_480x640.jpg?w=480&h=640&fit=crop&s=f0a84706bc91a6f505e8ad35f520f0b7" alt="" />
        </div>
        <div className='relative object-cover font-[font2] text-black'>
  ...
  <div className=" section2 grid grid-cols-3 gap-10 mb-40">
  ...
  <div className="grid grid-cols-3 gap-14 text-xl leading-relaxed">
    ...
    <p>
      Notre culture_ c’est l’ouverture aux autres. Tout l’équipage participe à bâtir une agence dont on est fiers.
    </p>
